        ...
        if (check_field.length > 0  ) {
            swal({
                ...
                closeOnConfirm: true
                    ...
                    $('#ppom_delete_selected_products_btn').html('Borrando...');
			        ...
			        $.post(ajaxurl, data, function(resp){
			        	$('#ppom_delete_selected_products_btn').html('Borrar');
			        	if (resp) {
					        swal({title: "Terminado", text: resp, type: "success" ,confirmButtonColor: '#217ac8'},
						        function(){ 
						            location.reload();
					        });
			        	}else{
            ...
            swal("Primero selecione un Grupo!", "", "error");
        }
    });
