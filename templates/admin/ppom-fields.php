...
if( ! defined('ABSPATH' ) ){ exit; }
	...
	echo '<p><a class="btn btn-primary" href="'.$url_cancel.'">'.__('&laquo; Atras', "ppom").'</a></p>';
	...
	<div class="ppom-main-field-wrapper">
		<form class="ppom-save-fields-meta">
			...
			<div class="ppom-basic-setting-section">
				<h2 class="ppom-heading-style"><?php _e('CONFIGURACION BASICA DE UN GRUPO', "ppom"); ?><span></span></h2>
				<div class="row">
		    ...
		    <div class="table-responsive"> 
		    	<h2 class="ppom-heading-style"><?php _e('AGREGA CATEGORIAS A TU GRUPO', "ppom"); ?></h2>  
